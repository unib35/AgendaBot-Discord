...
| 명령어 | 설명 | 특징 |
|--------|------|------|
| `/check` | ☑️ 체크리스트 관리 | 드롭다운으로 안건 선택, 버튼으로 항목 토글 |
